...
/**
 * PstcCustomerSearch represents the model behind the search form of `common\models\referral\Customer`.
 */
class PstcCustomerSearch extends Customer
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query = Customer::find()->where('rstl_id =:rstlId',[':rstlId'=>$rstlId]);
