                ...
                if(Yii::$app->controller->action->id === 'update'){
                    ...
                    $sampleGridColumns = [
                        ...
                        [
                            ...
                            //    return ['onchange' => 'activateSelect(this.value,this.checked)'];
                            //},
                            //'multiple' => false,
                        ],
                        [
            ...
            echo $form->field($model,'sampletype_id')->widget(Select2::classname(),[
                ...
                'pluginEvents' => [
                    "change" => "function() {
                        ...
                        if (sampletypeId > 0){
                            $.ajax({
                                url: '".Url::toRoute("pstcanalysis/get_testname")."',
                                method: 'GET',
            ...
            echo $form->field($model,'testname_id')->widget(Select2::classname(),[
                ...
                'pluginEvents' => [
                    "change" => "function() {
                        ...
                        var analysisId = '".$model->pstc_analysis_id."';
                        $.ajax({
                            url: '".Url::toRoute("pstcanalysis/get_testnamemethod")."',
                            //dataType: 'json',
                            method: 'GET',
    ...
    if(Yii::$app->controller->action->id === 'update'){
        $this->registerJs("
            $('#add_analysis').on('click',function(){
                ...
                else if ($('input[type=radio][name=method_id]', '#method-reference-grid').length < 1) {
